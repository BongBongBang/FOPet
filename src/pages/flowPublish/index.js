...
import flowTopicStore from "../../reducers/flowTopic/flowTopicStore";
      ...
      case "add":
        ...
        this.setState({
          ...
          for (let [key, value] of files.entries()) {
            ...
            topicsApi.publishImageUpload.apply(this, [{value, key, total: length}]);
          }
        });
        break;
      case "remove":
      ...
      <Block>
        {
          uploadLoading && <LoadingView
            ...
            content={constants.loading.content}
          />
        }
        <View
          ...
          <View className='pet-flowPublish-publish'>
            <View className='pet-flowPublish-publish-content'>
              ...
              <View className='pet-flowPublish-publish-content-bottom'>
                <View
                  className='at-row at-row--no-wrap pet-flowPublish-publish-content-topic'
                >
                  <View className='at-col at-col-2 pet-flowPublish-publish-content-topic-title'>
                    {constants.publish.label.adoption}
                  </View>
                  <View className='at-col at-col-9 pet-flowPublish-publish-content-topic-content'

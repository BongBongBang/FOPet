  ...
  render() {
    ...
    return (
      <View className='pet-disease'>
        ...
        />
        <View className='pet-disease-symptoms'>
          ...
          <View className='pet-disease-illness-list'>
            {
              ...
              }) : (!illness || illness.length <= 0) ? <EmptyView
                className='pet-disease-empty'
                icon='petPlanet-cat-ao'
                prefix='iconfont'
                size={48}
                color='#000'
                description='啊哦~铲屎官搜索不到任何患病的结果'
              /> : <View className='pet-disease-searchLoading'>
                <AtActivityIndicator

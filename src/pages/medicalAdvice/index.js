...
import {medicalAdviceAPI} from "../../services";
...
@connect(function mapStateToProps(state, ownProps) {
  return {
    ...
    medicalAdviceStore: state.medicalAdviceStore
  };
  ...
  return {
     ...
     */
    changeCurrentInit() {
      dispatch(changeCurrent({current: 1}));
    }
  };
})
class MedicalAdvice extends Component {
  ...
  render() {
    ...
    let {bannerList, consultingNewsList, tabBarInfo} = this.state;
    ...
    >
      ...
      >
        {
          bannerList.length > 0 && bannerList.map((bannerItem, bannerIndex) => {
            return (
              <SwiperItem
                key={bannerIndex}
              >
                      ...
                      return (
                        ...
                        >
                          <View className='pet-medicalAdvice-content-consultingNews-list-item-title'>
                            <View className='at-row pet-medicalAdvice-content-consultingNews-list-item-container'>
                              <View className='at-col-10'>
                                ...
                                />
                                <Text className='at-row pet-medicalAdvice-content-consultingNews-list-item-txt'>
                                  {item["phone"]}咨询
                                  <Text
                                    decode

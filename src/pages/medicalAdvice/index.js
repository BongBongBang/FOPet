    ...
    return (
      <Block>
        ...
        }
        {
          ...
          </View> : <View className={cns(
            'pet-medicalAdvice-empty',
            {'pet-medicalAdvice-empty-adaption': !!isX}
          )}>
            <AtIcon
              className='pet-medicalAdvice-empty-icon'
              prefixClass='iconfont'
              value='petPlanet-cat-ao'
              color='#000'
              size={48}
            />
            <View className='pet-medicalAdvice-empty-title'>
              啊哦~~~
            </View>
            <View className='pet-medicalAdvice-empty-description'>
              医疗咨询敬请期待
            </View>
          </View>
        }

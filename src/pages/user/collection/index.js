...
class Collection extends Component {
  ...
  getPetCollectionDetailHandler = (id, avatarUrl, nickName) => {
    Taro.navigateTo({
      url: `${pageCurrentList[6]}?id=${id}&avatarUrl=${avatarUrl}&nickName=${nickName}&page=collection`
    });
  };
  ...
  render() {
    ...
    return (
      <View className='pet'>
        ...
        {
          petCollectionList && petCollectionList.length <= 0 && <EmptyView
            className='pet-collection-empty'

  ...
  render() {
    ...
    return (
      <View className='pet-communications'>
            ...
            <View className='pet-communications-container'>
              <View className='pet-communications-os'>
                ...
                >
                  ...
                  >
                    {communicationsOS['createTime'] ? dayjs(communicationsOS['createTime'], 'YYYY-MM-DDTHH:mm:ss.000ZZ').fromNow() : ''}
                  </Text>
                  <Text
              ...
              >
                ...
                <View className='pet-communications-qs-imgArea'>
                  {
                    osImg && osImg.length > 0 ? (osImg.length > 1 ? <LdmImagePicker
                      mode='aspectFill'
                      ...
                      >
                        ...
                        >
                          <Text
                            decode
                          >
                            {communicationItem['createTime'] ? dayjs(communicationItem['createTime'], 'YYYY-MM-DDTHH:mm:ss.000ZZ').fromNow() : ''}
                          </Text>
                        </View>
                        <View
        ...
        <View className='pet-communications-communicationsBar'>
          <LdmInputPanel
            isPanel={isPanel}
            isFocus={isFocus}
            ...
            renderPanel={
              <View className='pet-communications-panel-func'>
                {
                  communicationsFunc && communicationsFunc.length > 0 && communicationsFunc.map((item, index) => {
                    return <View
                      key={item.id}

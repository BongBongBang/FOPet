  ...
  renderShowContent = (msgType = '', item = {}) => {
    ...
    switch (msgType) {
      ...
      case constants.msgType.TINY_GOODS_DETAIL: {
        return <View className='pet-communications-item-content-goodsDetail'
        ...
        >
          <Image
            src={data.coverPic}
            mode='aspectFill'
            className='pet-communications-item-content-goodsDetail-avatar'
          />
          <View className='pet-communications-item-content-goodsDetail-title'>
            {data.goodsName}
            <View className='pet-communications-item-content-goodsDetail-price'>
              <View className='pet-communications-item-content-goodsDetail-price-disc'>
                <Text className='pet-communications-item-content-goodsDetail-price-disc-symbol'>
                  &#165;
                </Text>
                {data.floorDiscPrice}
              </View>
              <View className='pet-communications-item-content-goodsDetail-price-real'>
                <Text className='pet-communications-item-content-goodsDetail-price-real-symbol'>
                  &#165;
                </Text>
                {data.floorPrice}
              </View>
          ...
          <Image
            className='pet-communications-item-content-goodsDetail-go'
            mode='widthFix'
            src={imgs.back}
          />
        </View>;

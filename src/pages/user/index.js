...
import {homeAPI, userAPI} from "../../services";
...
class User extends Component {
  ...
  render() {
    ...
    const {getUserInfo, usersCollection, usersPublishMine, filterDotTabBarList} = this;
    const {tabBarInfo, tabBarTabList} = this.state;
    ...
    return (
      <View className='pet-me'>
        ...
        <AtButton
          openType='contact'
          className='pet-me-information-contact'
          full
        >
          <View className='at-row'>
            ...
            <AtIcon
              prefixClass='iconfont'
              value='petPlanet-customerService'
              color='#fb2a5d'
              size={22}
            />
          </View>

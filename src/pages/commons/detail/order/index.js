...
class CommonOrder extends Component {
  ...
  verify = () => {
    ...
    const fullIDCardRemark = filterOption.findIndex(optionItem => !optionItem.remark);
                ...
                >
                  ...
                  <View className='order-remark'>
                    ...
                    <View className='order-remark-content'>
                      <AtInput
                        placeholder={_item.isFullIDCard ? constants.order.placeholder.IDCardRemark : constants.order.placeholder.remark}

...
class CommonOrderDetail extends Component {
  ...
  componentWillMount() {
    let {params: {order = '', orderNo = '', orderId = 0, docId = 0, consultType = 'SYSTEM', uploadConsultImages = '', consultContent = '', orderType = '2'}} = this.$router;
  ...
  onRedirectToDetail = (e = {}) => {
    ...
    Taro.redirectTo({
      url: `${pageCurrentList[32]}?id=${_item.orderItem.goodsId}`
    });
  };

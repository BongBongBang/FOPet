...
class Index extends Component {
  ...
  getPetDetailHandler = (id, avatarUrl, nickName) => {
    Taro.navigateTo({
      url: `${pageCurrentList[6]}?id=${id}&page=index&avatarUrl=${avatarUrl}&nickName=${nickName}`
    });
  };
      ...
      <View className='pet'>
        ...
        }
        {
          isShow ? <Block>
            ...
            />
            {
              petList && petList.length <= 0 && <EmptyView
                className='pet-business-empty'
                prefix='iconfont'

...
class ShareDetail extends Component {
  ...
  render() {
    const {detailStore} = this.props;
    const {onPreviewImage, setCollectionConfig, adaptationNavBar, backToMasterHome, onImageLoad} = this;
    ...
    return (
      ...
      >
        ...
        <View className='at-row at-row--no-wrap pet-detail-header'>
          <View className='at-col at-col-10 at-col__offset-1 at-col--wrap pet-detail-header-container'>
            {
        ...
        <View className='pet-detail-content'>
          ...
          <View className='pet-detail-content-area'>
            <AtIcon
              ...
              value='petPlanet-position-detail'
              className='pet-detail-content-area-icon'
              size={14}
              color='#999'
            />
            {area}

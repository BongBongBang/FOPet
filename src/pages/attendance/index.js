                ...
                (signArr && signArr.length > 0) ?
                  ...
                  <View className='pet-attendance-list-noSignList'>
                    <AtIcon
                      ...
                      size={48}
                    />
                    {prompt["emptyList"]["attendance_page"]["content"]}
                  </View>
              }
            </View>
            <AtModal
              ...
              title={prompt["modal"]["attendance_page"]["isSigned"]["title"]}
              confirmText={prompt["modal"]["attendance_page"]["isSigned"]["confirmText"]}
              content={remarks}
              onConfirm={() => {
                setAttrValue({
                  modal: {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text className='at-fab__icon iconfont iconfont-petPlanet-medicalAdvice'>

...
class Attendance extends Component {
  ...
  render() {
    ...
    const {attendanceStore: {isPermission, accordion: {activeKey, hasMessage, dayOfMonth, coin, score, groupName, rank, dayOfContinuity, coinToday, scoreToday, signTime, signed}, signObject, signObjectType, modal: {sign: {isSigned, data: {remarks}}}}, setAttrValue} = this.props;
    const {
      getUserInfoHandler = () => {
      },
      onRedPacketChangeHandler = () => {
        ...
        }
        {
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src='http://prod-pet.oss.1jtec.com/icon/red_packet.png'
                  mode='widthFix'

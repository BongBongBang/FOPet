            ...
            doctors.length > 0 && doctors.map((doctor, idx) => {
              return (
                <Label for={idx} key={doctor.userId}>
                  <View className='radio-item at-row'>
                    <View
                      className={`radio-item-content radio-item-content-select at-row at-row__align--center ${doctor.checked ? 'checked' : ""}`}
                    >
                      <AtAvatar
                        className='radio-item-content-avatar'
                        size='large'
                      ...
                      <View className='at-col at-row__align--start'>
                        ...
                        <View className='sub-title'>擅长领域：<Text className='sub-title-goodAt'>{doctor.goodAt}</Text></View>

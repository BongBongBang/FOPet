...
import {setTopicsAttrValue} from "../topics/topics_action";
...
import "./index.less";
import {setFindTopicsAttrValue} from "../findTopics/topics_action";
...
class TopicsDetail extends Component {
   ...
   */
  onFocusHandler = async (value, event) => {
  ...
  render() {
    ...
    const {navBarHeight, navBarClassName} = Tools.adaptationNavBar();
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            ...
            <View className='pet-topic-detail-content-imageList'>
              {
                ...
                >
                  ...
                  />
                                 ...
                                 mode='widthFix'
                                 onClick={() => showImageDetail(1, imgList[0], imgList)}
                >
            ...
            <View className='pet-topic-detail-content-share'>
              ...
              >
                <Image src='https://api.csg.1jtec.club/tinyStatics/imgs/icon/wechat.png'
                       mode='aspectFill'
                >
                  ...
                  return (
                    ...
                    >
                      ...
                      <View className='pet-topic-detail-comments-content-item-view'>
                        ...
                        <View className='pet-topic-detail-comments-content-item-view-main'>
                          {commentItem['content']}
                        </View>
                        {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <View className='pet-topic-detail-subComments-content'>
                                      ...
                                      <View className='pet-topic-detail-subComments-content-info'>
                                        {item['content']}
                                      </View>
                                    </View>
                                  </View>
        ...
        <View className='at-row at-row--no-wrap pet-topic-detail-topicBar'
              style={{bottom: `${inputDistanceBoard}px`}}
        >
          <View className='at-col-2 pet-topic-detail-topicBar-avatar'>
            <AtAvatar
              image={_avatarUrl}
              circle
              size='small'

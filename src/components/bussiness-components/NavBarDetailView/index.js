...
class NavBarDetailView extends Component {
  ...
  render() {
    const {className = '', onClickLeftIcon, avatar, nickName, onClick = () => {}} = this.props;
    ...
    return (
      ...
      >
        <View class='at-row at-row--no-wrap nav-bar'>
          <View className='at-col-1 pet-detail-navBar-information-back'
          ...
          <View className='at-col-8 pet-detail-navBar-user'
          >
            <AtAvatar
              image={avatar}
              circle

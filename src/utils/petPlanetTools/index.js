    ...
    adaptationNavBar() {
      ...
      if (system.indexOf('OS') !== -1) {
        if (model === 'iPhone X') {
          ...
          navBarAdaptation['statusBarClassName'] = 'pet-detail-iPhone12-navBar';
          navBarAdaptation['navBarHeight'] = 184;
          navBarAdaptation['navBarPaddingTop'] = 82;
          navBarAdaptation['isX'] = true;
        } else if (model.indexOf('iPhone13') !== -1) {
          navBarAdaptation['statusBarClassName'] = 'pet-detail-iPhone13-navBar';
          navBarAdaptation['navBarHeight'] = 184;
          navBarAdaptation['navBarPaddingTop'] = 82;
          navBarAdaptation['isX'] = true;
        } else if (model.indexOf('-inch') !== -1) {
          navBarAdaptation['statusBarClassName'] = 'pet-detail-iPhoneInch-navBar';

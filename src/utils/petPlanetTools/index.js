...
import {getSetting, chooseLocation, authorize, openSetting, getLocation} from "./getSetting";
import {getShareInfo} from "./getShareSetting";
import {getUserInfo} from "./getUserInfo";
import loginCode from "./loginCode";
import {previewImage} from "./imageOperation";
import {updateManger} from "./updateManager";
...
const PetPlanetTools = (function () {
  ...
  class PetPlanetTools {
    ...
    getLocationConfig(params) {
      return getLocation.apply(this.wx, [params]);
    }
    ...
    previewImageConfig(params) {
      return previewImage.apply(this.wx, [params]);
    }
    ...
    updateManagerConfig(forceUpdate) {
      updateManger.apply(this.wx, [forceUpdate]);
    }
    ...
    getShareInfoConfig(params) {
      return getShareInfo.apply(this.wx, [params]);
    }
    ...
    getUserInfoConfig(params) {
      return getUserInfo.apply(this.wx, [params]);
    }
    ...
    getMomentConfig(params) {
      return getMoment.apply(this.wx, [params]);
    }
